...
//ADD_EXPENSE
//We destructure the values and set up defaults as first argument. We can define all of the things we want to grab as first argument. If nothing exist it will be an empty object. After defining the things, we will attach them to the expense object by using the shorthand syntax.
...
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: 12400, createdAt: -1000 }));
